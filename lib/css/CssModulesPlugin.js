...
const {
	CSS_MODULE_TYPE,
	CSS_MODULE_TYPE_MODULE_GLOBAL,
	CSS_MODULE_TYPE_MODULE_LOCAL,
				...
				for (const type of [
					...
					normalModuleFactory.hooks.createParser
						...
						.tap(PLUGIN_NAME, parserOptions => {
							...
							switch (type) {
								case CSS_MODULE_TYPE_MODULE_GLOBAL:
								...
								case CSS_MODULE_TYPE_MODULE_LOCAL:
									return new CssParser({
										defaultMode: "local",
										namedExports
									});
